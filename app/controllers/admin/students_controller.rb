...
class StudentsController < Admin::AdminController
  ...
  def destroy
    @student.destroy
    respond_to do |format|
      format.html { redirect_to [:admin,students_url], notice: 'Student was successfully destroyed.' }
  ...
  private
    ...
    def student_params
      params.require(:student).permit(:first_name, :last_name, :email, :study_type_enum)
    end
end
end
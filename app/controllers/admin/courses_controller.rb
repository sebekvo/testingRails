...
class CoursesController < Admin::AdminController
  ...
  def destroy
    @course.destroy
    respond_to do |format|
      format.html { redirect_to [:admin,courses_url], notice: 'Course was successfully destroyed.' }
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:title, :code, :study_type_enum, :language_enum)
    end
end
end